...
The current live-approved Paper 26.2 baseline is build 221, preserved by the
`1mb-lootchest-v2.5.9.1-build221-approved` tag. Build 220 is the immediately
...
```text
target/1MB-LootChest-v2.5.9.1-221-CMI-j25-26.2.jar
```
